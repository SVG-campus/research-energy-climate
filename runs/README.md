...
**`notebooks/CHARTER_OPEN_METEO_STREAM_SMOKE.ipynb`** runs next: small streaming slice of the pinned Open-Meteo Hub table + y-shuffle null + run card (methodological sanity only).
